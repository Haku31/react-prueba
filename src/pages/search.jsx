...
const search = () => {  
        ...
        const filtrar = (terminoBusqueda)=>{
            ...
            return setPro(resultadoBusqueda)
        }
    return (
        ...
        <div  className="row">
                        ...
                        <div className="col-lg-4 col-sm-9 col-9 mt-2">
                        ...
                        <div className="col-lg-4  col-2 mt-4 ">
                            ...
                            <button  className="btn d-none d-lg-inline-block" type="submit">Iniciar sesion</button>
                        </div> 
                        ...
                        <section className="main-container">
                            ...
                            {results.filter((elemento)=>{
                                if (elemento.title.toString().toLowerCase().includes(busqueda.toLowerCase())) {
                                    console.log(elemento)
                                    return elemento
                                }
